	...
	$this->db->query("CREATE TABLE IF NOT EXISTS `".$bid."_outboundcalls` (
		...
		$this->db->query("CREATE TABLE IF NOT EXISTS `".$bid."_mtracker` (
			...
			$this->db->query("CREATE TABLE IF NOT EXISTS `".$bid."_mt_emplist` (
						  ...
						  `last_location` VARCHAR(255) NOT NULL DEFAULT '0,0',
			...
			$this->db->query("CREATE TABLE IF NOT EXISTS `".$bid."_mt_emptimecheck` (
		     ...
		     $this->db->query("CREATE TABLE IF NOT EXISTS `".$bid."_callbyreference` (
						  `rid`int(11) NOT NULL,
						  `bid`int(11) NOT NULL,
						  `name` varchar(100) NOT NULL,
						  `email` varchar(100) NOT NULL,
			...
			$this->db->query("CREATE TABLE IF NOT EXISTS `".$bid."_callbyref_rep` (
						`callid` varchar(25) NOT NULL,
						`refid` int(11) NOT NULL,
						`bid` int(11) NOT NULL,
						`name` varchar(100) NOT NULL,
		    ...
		    $this->db->query("CREATE TABLE `".$bid."_callbyref_archive` (
					  `callid` varchar(25) NOT NULL,
					  `refid` int(11) NOT NULL,
					  `bid` int(11) NOT NULL,
					  `name` varchar(100) NOT NULL,
            ...
            $this->db->query("CREATE TABLE IF NOT EXISTS `".$bid."_callref_uploadfailed` (
						`name` varchar(100) NOT NULL,
						`number` varchar(20) NOT NULL,
						`email` varchar(100) NOT NULL
						) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
