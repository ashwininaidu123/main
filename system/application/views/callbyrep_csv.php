	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4><?php echo $this->lang->line('level_callbyrep');?></h4>
			</div>
			<div class="modal-body">
				<div class="row">					
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<?php
							$attributes = array('class' => 'form', 'id' =>'callbyrep','name'=>'callbyrep');
					...
					<tr>
						...
						<td>
							<?php 
								...
								echo form_dropdown('empname[]',$this->groupmodel->empllist(),'',$js1);
							?>
						</td>
					</tr>
						<tr>
						...
						<td>
							<?php 
								$js1 = 'id="calltype" class="form-control" multiple';
								$options = array('Inbound',
								                 'outbound');
								echo form_dropdown('calltype[]',$options,'',$js1);
							?>
						</td>
					</tr>
				</TABLE>
				...
				<td colspan="3"><h4><?php echo "Listing Fields";?></h4>
						...
						foreach($systemfields as $field){
							...
							if($field['type']=='s' && $field['show']){
								...
								if($checked && !in_array($field['fieldname'] ,array('email','contactno','callid','filename'))){ 
