	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4><?php echo $this->lang->line('level_callbyref');?></h4>
			</div>
			<div class="modal-body">
				<div class="row">					
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<?php
							$attributes = array('class' => 'form', 'id' =>'callbyref','name'=>'callbyref');
				...
				<td colspan="3"><h4><?php echo "Listing Fields";?></h4>
						...
						foreach($systemfields as $field){
							...
							if($field['type']=='s' && $field['show']){
								...
								if($checked && !in_array($field['fieldname'] ,array('email','number'))){ 
