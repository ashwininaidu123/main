...
// New release page;
$route['NewRelease']					    ='Report/new_release';

// New products page;
$route['MCubeProducts']				    	='Report/mcube_products';

// Call By Reference;
$route['AddReference/(.*)']					='callbyref/addreference';
$route['ListReference/(.*)']				='callbyref/listreference';
$route['EditReference/(.*)']				='callbyref/editpopup/$1';
$route['CallbyRefReports/(.*)']				='callbyref/reports';
